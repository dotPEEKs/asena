...
"}	")
        ...
        icon3 = QIcon()
        icon3.addFile(u":/resources/settings.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.minisidebar_settings_btn.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/resources/logout.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.minisidebar_exit_btn.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/resources/sidebar_toggle.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.sidebar_toggle_btn.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/resources/minimize_new.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/resources/fullscreen.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/resources/close_new.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
